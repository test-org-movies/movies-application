...
//     $('#renderGenre').val(movieArr[2].split(' ')[1]);
// });
// function movieObject(title,rating,genre,id) {
...
// //on btn click update
// $('#editMovieBtn').click(function (e) {
//     let title = $('#renderTitle').val();
//     let rating = $('#renderRating').val();
//     let genre = $('#renderGenre').val()
//     let id = targetIDGrab;
//     console.log("this is the title rating genre and id" + title + " " +  rating  + " " + genre + " "+ id)
//     ;
//      let movieObject =   movieObject(title,rating,genre,id);
//
//     e.preventDefault();
//     getMovies().then((movies) => {
//         console.log(movies.id + " " + movieObject.id);
//         if(movies.id === movieObject.id) {
//             editMovie(movieObject);
//             getMovies().then((movies) => {
//                 (renderMovies(movies));
//             });
